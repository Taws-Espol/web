		...
		<div className="Main grid grid-cols-1 justify-items-center max-w-full">
			<div className="flex-col w-4/5 mt-20">
				<div class="flex flex-row flex-wrap">
					<div class="lg:basis-1/2 max-w-full">
						<h1 className="text-white font-medium text-5xl sm:text-6xl">BE DIFFERENT</h1>
						<h1 className="text-tawsBlue font-bold text-8xl max-w-full">BE TAWS</h1>
					...
					<div class="hidden lg:basis-1/2 lg:block">
